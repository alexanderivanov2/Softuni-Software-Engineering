...
#         food_test = [f for f in self.food_menu if f.name == name]
#         if food_test:
...
#         drink_test = [d for d in self.drinks_menu if d.name == name]
#         if drink_test:
...
#         is_table = [t for t in self.tables_repository if t.table_number == table_number]
#         if is_table:
...
#             if t.capacity >= number_of_people and not t.is_reserved:
...
#             message += f"{table.free_table_info()}\n"
#         return message
#
